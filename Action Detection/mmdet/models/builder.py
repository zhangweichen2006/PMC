...
def build_detector(cfg, train_cfg=None, test_cfg=None, revep=10, da_w=0.1):
    from . import detectors
    return build(cfg, detectors, dict(train_cfg=train_cfg, test_cfg=test_cfg, revep=revep, da_w=da_w))
