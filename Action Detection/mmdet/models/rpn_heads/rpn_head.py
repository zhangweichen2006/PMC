...
class RPNHead(nn.Module):
    ...
    def loss(self, rpn_cls_scores, rpn_bbox_preds, gt_bboxes, img_shapes, cfg, is_flow=False):
        ...
        if not is_flow:
            ...
            return dict(loss_rpn_cls_flow=losses_cls, loss_rpn_reg_flow=losses_reg)
