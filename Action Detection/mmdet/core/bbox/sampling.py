...
def sample_bboxes(bboxes, gt_bboxes, gt_bboxes_ignore, gt_labels, cfg=None, roi_batch_size=0, iou_th=0):
    ...
    if roi_batch_size == 0:
        roi_batch_size = cfg.roi_batch_size

    pos_inds, neg_inds = bbox_sampling(
        assigned_gt_inds, roi_batch_size, cfg.pos_fraction, cfg.neg_pos_ub,
