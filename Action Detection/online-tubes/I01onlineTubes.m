...
save_root = '/home/rusu5516/project/faster-rcnn';
iteration_nums = [10000]; % you can also evaluate on multiple iterations
                    ...
                    for iteration = iteration_nums
                        for iouthresh=0.1
                            for gap=10
                                ...
                                dopts = initDatasetOpts(data_root,save_root,dataset,imgType,model_type,listid,iteration,iouthresh,costtype, gap, nms_th, score_th);
                                dopts.detDir
