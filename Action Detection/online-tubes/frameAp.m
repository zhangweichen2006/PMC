...
data_root = '/home/rusu5516/JAAD_dataset';
save_root = '/home/rusu5516/project/realtime-action-detection';
iou_th = 0.5;
model_type = 'CONV';
dataset = 'ucf24';
list_id = '01';
split_file = sprintf('%s/%s/splitfiles/testlist%s.txt',data_root,dataset,list_id);
annotfile = sprintf('%s/%s/splitfiles/finalAnnots.mat',data_root,dataset);
...
function dt_boxes = get_dt_boxes(detection_dir, video_name, nf, num_actions, fusion_type, action_class)
dt_boxes = [];
%% apply nms per class
