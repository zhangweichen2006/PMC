...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_full_data_stage4_scratch_2x_I3d_2cls'
load_from = './work_dirs/faster_rcnn_r50_fpn_1x_full_data_stage4_scratch_2x_I3d_2cls/epoch_1.pth'
resume_from = None
workflow = [('train', 1)]
