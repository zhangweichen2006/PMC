...
parser.add_argument('dataset', type=str, choices=['ucf101', 'hmdb51', 'kinetics','ucf101-10','hmdb51-10','ucf6','olympic6'])
...
parser.add_argument('--total_epochs', default=45, type=int, metavar='N2',
                    help='number of total epochs2 to run')
...
parser.add_argument('--main_w2', type=float, default=-0.5)
...
parser.add_argument('--learnCD', type=str2bool, default=True)
