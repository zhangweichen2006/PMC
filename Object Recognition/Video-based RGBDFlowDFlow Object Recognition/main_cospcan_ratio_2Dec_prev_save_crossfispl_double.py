...
def main():
    ...
    for epoch in range(args.start_epoch, args.total_epochs):
        ...
        adjust_learning_rate(optimizer_c, args.lr, decay)
...
def train(dsets, transforms, dset_loaders, train_source_iter, train_target_iter, train_source_iter2, train_target_iter2, model, model2,
            Pseudo_set, Pseudo_set2, Pseudo_set_co, criterion, domain_criterion, optimizer, dom_optimizer, dom_w_optimizer, dom_feat_optimizer, optimizer2, dom_optimizer2, dom_w_optimizer2, dom_feat_optimizer2, epoch, pre_epochs, num_class, c_1, d_1, fd_1, c_2, d_2, fd_2):
...
def validate(val_iter, val_iter2, model, model2, criterion, domain_criterion, iter, epoch, pre_epochs, optimizer_c, optimizer_d, optimizer_fd, logger=None):
    ...
    for cnt in range(len(val_iter)):
        ...
        # loss = 1* ( d_rgb * dom_loss.data[0] + (1 - d_rgb) * dom_loss2.data[0] )
        #        - c_rgb * 
        # pre_epochs = 1
        ...
        if epoch >= pre_epochs and args.learnCD:
          c_loss = -torch.abs(c_2 * confid_rate2.data[0] -  c_1 * confid_rate.data[0]) #+ 0.1*c_rgb*c_rgb
          # print("c_loss", c_loss)
