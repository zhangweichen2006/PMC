# VER="1.1.2_h2u_04-08_10w_lr15_lr1_noweight_1ratio_correctw_pre0.2_0.2defaultp_250epoch_1skip_save180200_3Dec"
...
# MP=1
# UT1="False"
# nohup python main_cospcan_ratio_2Dec_prev_save_cospl.py hmdb51-10 $MODE $MODE2 datalist/$SOURCE.txt datalist/$TARGET.txt datalist/$SOURCE2.txt datalist/$TARGET2.txt --usingTriDec $TD --usingTriDec2 $TD2 --max_pseudo $MP --useT1Only $UT1 --arch BNInception --skip $SKIP --usePrevAcc $USEPREV --defaultPseudoRatio $DEFP --defaultPseudoRatio2 $DEFP2 --pseudo_ratio $PSR --pseudo_ratio2 $PSR2 --usingDoubleDecrease $DD --usingDoubleDecrease2 $DD2 --num_segments 3 --gd 20 --lr $LR --lr2 $LR2  --lr_steps 180 230 --pre_ratio $PRERATIO --epochs $EPOCHS --epochs2 $EPOCHS2 -b $BATCH -j 8 --dropout 0.7 --dropout2 0.8 --snapshot_pref $VER --form_w $FW --main_w $MW --wt $WT --flow_pref $FLOWPREF > $VER.txt &

VER="1.1.5_h2u_00-01_10w_lr15_lr1_noweight_1ratio_correctw_pre0.2_0.2defaultp_250epoch_1skip_save_Double3Dec_CODANN_crossfispl_rightres2"
SOURCE="hmdb51_flow_test_split_1"
TARGET="ucf101_flow_test_split_1"
SOURCE2="hmdb51_rgb_test_split_1"
TARGET2="ucf101_rgb_test_split_1"
...
MP=1
UT1="False"
nohup python main_cospcan_ratio_2Dec_prev_save_crossfi_double.py hmdb51-10 $MODE $MODE2 datalist/$SOURCE.txt datalist/$TARGET.txt datalist/$SOURCE2.txt datalist/$TARGET2.txt --usingTriDec $TD --usingTriDec2 $TD2 --max_pseudo $MP --useT1Only $UT1 --arch BNInception --skip $SKIP --usePrevAcc $USEPREV --defaultPseudoRatio $DEFP --defaultPseudoRatio2 $DEFP2 --pseudo_ratio $PSR --pseudo_ratio2 $PSR2 --usingDoubleDecrease $DD --usingDoubleDecrease2 $DD2 --num_segments 3 --gd 20 --lr $LR --lr2 $LR2  --lr_steps 180 230 --pre_ratio $PRERATIO --epochs $EPOCHS --epochs2 $EPOCHS2 -b $BATCH -j 8 --dropout 0.7 --dropout2 0.8 --snapshot_pref $VER --form_w $FW --main_w $MW --wt $WT --flow_pref $FLOWPREF > $VER.txt &
