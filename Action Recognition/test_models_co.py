...
from models_cospcan import TSN
...
net = TSN(num_class, 1, args.modality,
          ...
          dropout=args.dropout, form_weight=args.form_w, 
          last_weight=args.main_w, init_w_l2=init_w_l2, 
          init_w_l3=init_w_l3, init_w_l4=init_w_l4, 
          init_w_main=init_w_main
          )

checkpoint = torch.load(args.weights)
print("model epoch {} best prec@1: {}".format(checkpoint['epoch'], checkpoint['best_prec1']))

state_dict = list(checkpoint['state_dict'].keys())

# print(state_dict)

# print(net.parameters())

# base_dict = {'.'.join(k.split('.')[1:]): v for k,v in list(checkpoint['state_dict'].items()) if "var" not in k}
