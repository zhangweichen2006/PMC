...
def train(dsets, transforms, dset_loaders, train_source_iter, train_target_iter, train_source_iter2, train_target_iter2, model, model2,
    ...
    print("batchsizes2: S, Pseu, d_all, dt", source_batchsize2, pseudo_batchsize2, d_pseudo_all_batchsize2, d_target_batchsize2)
    ...
    # for i, (input, target) in enumerate(source_loader):
        ...
        if epoch < pre_epochs or pseudo_batchsize <= 0:
            ...
            if d_target_batchsize > 0:
                ...
                # print("len(d_inputs, d_pseudo_source_inputs, d_pseudo_all_inputs, d_target_inputs)", len(d_inputs), len(d_pseudo_source_inputs), len(d_pseudo_all_inputs), len(d_target_inputs))
                ...
                # print("len(d_inputs, d_pseudo_source_inputs, d_pseudo_all_inputs)", len(d_inputs), len(d_pseudo_source_inputs), len(d_pseudo_all_inputs))
            ...
            if d_target_batchsize2 > 0:
                ...
                # print("len(d_inputs2, d_pseudo_source_inputs2, d_pseudo_all_inputs2, d_target_inputs2)", len(d_inputs2), len(d_pseudo_source_inputs2), len(d_pseudo_all_inputs2), len(d_target_inputs2))
                ...
                # print("len(d_inputs2, d_pseudo_source_inputs2, d_pseudo_all_inputs2)", len(d_inputs2), len(d_pseudo_source_inputs2), len(d_pseudo_all_inputs2))
