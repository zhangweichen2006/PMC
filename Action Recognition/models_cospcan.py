...
TSN Configurations:
    ...
    def forward(self, cond, input, input2=None, l=None):
     ...
     #            init_w_l2=None, init_w_l3=None):
        ...
        if (cond == 'pseudo_discriminator'): 
            ...
            return class_pred.squeeze(1), dom_pred.squeeze(), dom_pred_l2.squeeze(), dom_pred_l3.squeeze(), \
        ...
        if cond == 'dom_train':
            ...
            return dom_pred.squeeze(), dom_pred_l2.squeeze(), \
